...
def demarrer_serveur(port):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket: #échange tcp
        ...
        while True:
            ...
            with client_socket:
                client_socket.settimeout(10)  # Définir un timeout de 10 secondes
                ...
                try:
                    ...
                    if not resultat:
                        ...
                        print(f"Transaction sur la caisse avec l'id {num_caisse}")
                    ...
                    if client_info:
                        ...
                        if prix_menu_selectionne is not None:
                            ...
                            while True:
                                client_socket.sendall("Avez-vous pris un supplément ? (oui/non)\n".encode('utf-8'))
